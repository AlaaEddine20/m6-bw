const dynamicResume= (options,exp, themeOptions)=>{
    return `
    <!doctype html>
<html lang="en">
<head>
        ...
        <div class="box">
            ...
            <div class="left-side d-inline-block">
                <div class="profile-image">
                    <img class="img-fluid" src=${options.image} alt="">
                </div>
                ...
                <div class="skill ml-2 mt-2">
                    <div class="heading-text text-uppercase">Experiences</div>
                    <p class="para mb-1">
                    ${exp.description}
                    // ${exp.company} <br>
                    // ${exp.role} <br>
